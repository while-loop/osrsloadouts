...
deploy: context ## deploy latest built container to docker hub
	...
	--set-env-vars OSRSLOADOUTS_MONGO_ADDR="${OSRSLOADOUTS_MONGO_ADDR}",OSRSLOADOUTS_MONGO_DB=${OSRSLOADOUTS_MONGO_DB},OSRSLOADOUTS_REDIS_ADDR=${OSRSLOADOUTS_REDIS_ADDR},OSRSLOADOUTS_REDIS_PASS=${OSRSLOADOUTS_REDIS_PASS},OSRSLOADOUTS_REDIS_DB=${OSRSLOADOUTS_REDIS_DB},OSRSLOADOUTS_REDIS_TTL=${OSRSLOADOUTS_REDIS_TTL}
